...
class SortByTitlePage extends StatefulWidget {
  @override
  _SortByTitlePageState createState() => _SortByTitlePageState();
}

class _SortByTitlePageState extends State<SortByTitlePage> {
  ...
  Future<List<Movie>> _searchMovies(String query, int page) async {
    final url =
        '${ApiConfigs.url}/discover/movie?include_adult=false&include_video=false&language=pt-BR&page=$page&sort_by=title.asc';
